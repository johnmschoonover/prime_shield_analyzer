...
Due to security limitations in GitHub Markdown, fully interactive JavaScript charts (like the one generated by this application) cannot be embedded directly in this README.

However, the full **interactive HTML report** is automatically built and deployed to GitHub Pages. You can explore the data, zoom into charts, and hover over data points to see detailed statistics here:

👉 **[View Interactive Analysis Report](https://<username>.github.io/prime-shield-analyzer/)**
*(Note: Replace `<username>` with your GitHub username if forking this repository)*
